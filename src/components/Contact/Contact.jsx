...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://formsubmit.co/ajax/jfalasco88@gmail.com', form)
        .then((response) => {
            ...
            <div className="contact__container container grid">
                <div className="contact__content">
                    <div className="contact__card">
                        ...
                        <p className="contact__card--data">Araras / SP</p>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <p className="contact__card--data">Jfalasco88@gmail.com</p>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <p className="contact__card--data">(19) 99645-9448</p>
                    </div>
                </div>
